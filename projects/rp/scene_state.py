...
def build_scene_state_prompt(messages: list[dict], previous_state: str = "",
    ...
    return (
        ...
        "Strong emotions like grieving, panicking, crying, or distressed fade SLOWLY over many exchanges — if a character was in that state recently, keep the original emotion word alongside the new mood, e.g. 'playful, still grieving underneath')\n"
